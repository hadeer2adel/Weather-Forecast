...
class FavouriteFragment : Fragment() {
    ...
    private var language: String = "eg"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        language = AppSettings.getInstance(requireContext()).language
        ...
        binding.addBtn.setOnClickListener {
            ...
            navController.navigate(R.id.action_mainFragment_to_favouriteMapFragment)
        }
    }
